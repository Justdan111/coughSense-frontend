...
export function Footer() {
  return (
    <footer className="bg-ct-primary/6 text-ct-muted py-12 border-t border-slate-100 px-4">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-8 md:mb-12">
          <div className="sm:col-span-2">
            <div className="flex items-center gap-2 mb-4 md:mb-6 text-white">
              <Activity className="w-6 h-6 text-ct-primary" />
              <span className="font-bold text-lg md:text-xl text-ct">CoughTriage</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="#how-it-works" className="hover:text-ct transition-colors">
                  How it Works
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="hover:text-ct transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="hover:text-ct transition-colors">
                  Terms of Service
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/about" className="hover:text-ct transition-colors">
                  About
                </Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-ct transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
