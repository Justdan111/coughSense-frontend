    ...
    <section className="relative overflow-hidden py-12 px-4 sm:py-16 md:py-20 lg:py-32">
      <div className="container relative z-10 mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Clinical-Grade Cough Analysis{" "}
            <span className="text-brand-teal">Powered by AI</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Button size="lg" asChild className="bg-brand-teal hover:bg-brand-teal/90 text-base sm:text-lg h-12 sm:h-14 px-6 sm:px-8 w-full sm:w-auto">
              <Link href="/dashboard">Get Started Free</Link>
            </Button>
            <Button size="lg" variant="outline" className="text-base sm:text-lg h-12 sm:h-14 px-6 sm:px-8 bg-transparent w-full sm:w-auto">
              View Research
            </Button>
          </motion.div>
        </div>
